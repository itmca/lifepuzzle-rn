...
export const useVoicePermission = ({onAgree, onDeny}: Pick<Permission, "onAgree" | "onDeny">) => {
    useEffect(() => {
...
export const usePhotoPermission = ({onAgree, onDeny}: Pick<Permission, "onAgree" | "onDeny"> = {}) => {
