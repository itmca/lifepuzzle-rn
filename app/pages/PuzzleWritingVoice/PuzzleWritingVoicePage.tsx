...
import {usePermission, useVoicePermission} from "../../service/hooks/permission.hook";
import {useVoiceRecorder} from "../../service/hooks/voice-record.hook";


const PuzzleWritingVoicePage = (): JSX.Element => {
...
export default PuzzleWritingVoicePage;
