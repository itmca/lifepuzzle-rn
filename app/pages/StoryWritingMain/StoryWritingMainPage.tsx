...
import {
  useIsStoryUploading,
  useIsVoiceToTextProcessing,
} from '../../service/hooks/story.write.hook';
...
const StoryWritingMainPage = (): JSX.Element => {
  ...
  const isVoiceToTextProcessing = useIsVoiceToTextProcessing();
  ...
  return (
    <LoadingContainer isLoading={isStoryUploading || isVoiceToTextProcessing}>
